<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Default.aspx.vb"
    Inherits="EEVirtualLab.EEVirtualLab" %>
    ...
    <div id="art-main">
        <div class="art-Sheet">
                ...
                <div class="art-Header">
                    ...
                    <div class="art-Logo">
                        <h1 id="name-text" class="art-Logo-name">
                            <a href="#">IIT Delhi Virtual Labs</a></h1>
                                    ...
                                    <div class="art-BlockContent-body">
                                        <div >
                                            <table width = "95%" >
                                                <tr>
                                                    <td>
                                                        <asp:GridView ID="dgParameters" runat="server" CellPadding="4" Width="95%" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Value" ItemStyle-Width="100%">
                                                                    <ItemTemplate>
            ...
            <p class="art-page-footer">
                <a href="http://www.artisteer.com/">Web Template</a> created with Artisteer.</p>
        </div>
    </form>
</body>
</html>
